...
/**
 * @brief
 * Class with methods.They generate and add objects to List.
 */
class ListGenerator {
public:
    /**
     ...
     */
    void random_double(int count, List<double> *list);
     ...
     */
    void random_vector_int(int count, List<std::vector<int>> *list);

    /**
     * @brief
     * Generate 'count' random Books and add everyone to List.
     */
    void random_book(int count, List<Book> *list);

    /**
     * @brief
     * Generate 'count' random Characters and add everyone to List.
     */
    void random_character(int count, List<Character> * list);
};
